      ...
      <Row>
        <Col md={8} lg={9}>
          <Card className=" p-4">
            ...
            <Form.Control placeholder="Thanks for your business!" name="notes" value={this.state.notes} onChange={(event) => this.editField(event)} as="textarea" className="my-1" rows={1}/>
          </Card>
        </Col>
        <Col md={4} lg={3}>
